<template>
  <div class="artist-card-links" :class="rootCSSClasses">
    <ArtistCardLink v-for="item of items" :key="item.id" :item="item" />
  </div>
</template>

<script setup lang="ts">
import type { ArtistCardLinksProps } from '~/modules/artist/components/ArtistCardLinks/types';

const props = defineProps<ArtistCardLinksProps>();

const rootCSSClass = 'artist-card-links';
