...
import ArtistCardLinksSlider from '~/modules/artist/components/ArtistCardLinksSlider/ArtistCardLinksSlider.vue';
import type { SimilarArtistSliderProps } from '~/modules/artist/components/ArtistCardLinksSlider/types';
...
function renderComponent(props?: SimilarArtistSliderProps) {
  return render(ArtistCardLinksSlider, {
    global: {
      stubs: {
